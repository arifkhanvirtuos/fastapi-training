...
def init_db() -> None:
    ...
    try:
        from .models import User, Product, RawMaterial, UserProfile  # Import models here to register them with Base
    except ImportError:
        from models import User, Product, RawMaterial, UserProfile
